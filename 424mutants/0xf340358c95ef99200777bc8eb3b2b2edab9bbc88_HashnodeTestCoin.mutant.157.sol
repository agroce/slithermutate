...
contract HashnodeTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    uint256  totalEthInWei;         // WEI is the smallest unit of ETH (the equivalent of cent in USD or satoshi in BTC). We'll store the total ETH raised via our ICO here.  
