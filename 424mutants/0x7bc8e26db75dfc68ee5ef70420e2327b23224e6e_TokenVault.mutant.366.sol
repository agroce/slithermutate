...
contract TokenVault is Ownable {
  ...
  /** Sum from the spreadsheet how much tokens we should get on the contract. If the sum does not match at the time  the lock the vault is faulty and must be recreated.*/
