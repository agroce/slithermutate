...
contract MetaToken is PausableToken {
    ...
    uint256 public target   = 0x1ffff00000000000000000000000000000000000000000000000000000000; // i.e. difficulty. miner needs to find nonce, so that (hash(nonce+random) < target)
