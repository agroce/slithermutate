...
contract PolarisDEX is SafeMath {
  ...
  function trade(address tokenGet, uint amountGet, address tokenGive, uint amountGive, uint expires, int nonce, address user, uint8 v, bytes32 r, bytes32 s, uint amount) public {
